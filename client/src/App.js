...
const App = () => {
  ...
  const getMovieList = () => {
    axios
      ...
      .catch((err) => {
        setRequestError(
          `Unable to Load Movie List - ${err.response.status} ${err.response.statusText}`
        );
      });
  };
  ...
  const updateMovieList = (id, updatedMovie) => {
    axios
      ...
      .catch((err) => {
        setUpdateError(
          `Unable to Update Movie  - ${err.response.status} ${err.response.statusText}`
        );
      });
  };
  ...
  const deleteMovie = (id) => {
    axios
      ...
      .catch((err) => {
        setDeleteError(
          `Unable to Delete Movie  - ${err.response.status} ${err.response.statusText}`
        );
      });
  };
  ...
  const addMovie = (newMovie) => {
    ...
    axios
      ...
      .catch((err) => {
        setAddError(
          `Unable to Add Movie  - ${err.response.status} ${err.response.statusText}`
        );
      });
  };
  useEffect(() => {
